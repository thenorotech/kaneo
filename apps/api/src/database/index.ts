...
import {
  ...
  esjAreaTableRelations,
  esjPhaseTableRelations,
  esjPieceTableRelations,
  esjProjectTableRelations,
  esjRoleAssignmentTableRelations,
  esjSapIntakeTableRelations,
  esjTaskLinkTableRelations,
